...
for i = 1:n_train
    if p_1(data(i,1),data(i,2),Pi_MLE,mu_0_MLE,mu_1_MLE,sigma_0_MLE,sigma_1_MLE)>0.5
...
for i = 1:n_test
    if p_1(data_test(i,1),data_test(i,2),Pi_MLE,mu_0_MLE,mu_1_MLE,sigma_0_MLE,sigma_1_MLE)>0.5
